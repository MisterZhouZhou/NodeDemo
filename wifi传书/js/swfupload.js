...
SWFUpload.prototype.getFlashHTML = function (flashVersion) {
	// Flash Satay object syntax: http://www.alistapart.com/articles/flashsatay
	 ...
	 var classid = "";
	//如果是IE9,10 就添加calssid
    if (window.ActiveXObject){
		try{
//			if (+navigator.userAgenpt.toLowerCase().match(/msie ([\d.]+)/)[1].substring(0, 1) >= 9)
	...
	return ['<object  wmode="transparent"  '+classid+' id="', this.movieName, '" type="application/x-shockwave-flash" data="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
